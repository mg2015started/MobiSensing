...
//    Float a = labeledProbability.get("Bald");
//    Float b = labeledProbability.get("notBald");
//    Log.e("tag", Float.toString(a));
//    Log.e("tag", Float.toString(b));
...
//      Log.e("tag", entry.getKey()+" "+Float.toString(entry.getValue()));
